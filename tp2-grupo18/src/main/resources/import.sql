...
INSERT INTO consejo(conse_titulo,conse_texto,conse_autor,conse_estado) VALUES ('Esterilización o castración de los gatos','Esterilizar o castrar a los gatos aumenta la posibilidad de que estos animales tengan una vida más larga y saludable, ya que disminuye el riesgo de contraer enfermedades','Alejandra López',1);
INSERT INTO consejo(conse_titulo,conse_texto,conse_autor,conse_estado) VALUES ('¿Qué debo hacer si mi perro vomita?','Puede ser que su perro vomite en cualquier momento lo que no significaría ningún problema.La causa más frecuente de vómitos en los animales es la comida que se le ofrece fuera de su dieta. Por eso, es importante mantener una dieta controlada.','Julia Villen',1);
