...
public class ListaNoticia{
   ...
   public ListaNoticia() {
	   ...
	   noticias.add(new Noticia(1L,"CONSEJOS VETERINARIOS","Con el fin de dar la atención que un animal requiere es importante que cubramos todas sus necesidades básicas, debemos proveer un sitio adecuado para que descanse protegido de inclemencias climáticas y que mantenga una temperatura adecuada.\r\n"
	   ...
	   noticias.add(new Noticia(2L,"IMPORTANCIA DE EVITAR QUE NUESTRAS MASCOTAS SALGAN SOLAS DE CASA","Cuando una persona decide hacerse cargo de una mascota, debe saber que ha encontrado una gran compañía, pero también ha adquirido una gran responsabilidad. Una de estas responsabilidades, que viene dada por la ley 7451 y 2391, es mantener la mascota en condiciones óptimas que resguarden su bienestar y eviten riesgos para personas y otros animales.\r\n"
	   		...
	   		+ "Cuando tenemos una mascota agresiva y esta escapa de la casa, puede suponer un riesgo muy alto para las personas, ya que les puede generar lesiones y eso nos traerá prob lemas desde el punto de vista legal. La mascota se podrá extraviar o ser robada.","Anonimo2",LocalDate.of(2010,07,22),true));
   }
