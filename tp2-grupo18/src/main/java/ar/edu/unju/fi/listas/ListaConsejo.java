...
public class ListaConsejo{
   ...
   public ListaConsejo(){
	   ...
	   consejos.add(new Consejo("Consejo de Salud para nuestra mascotas Son realmente importante","La vacunación de los animales de compañía es el método preventivo más adecuado para evitar la aparición de diversas enfermedades.\r\n"
	   ...
	   consejos.add(new Consejo("las principales enfermedades del perro que se evitan con la vacunación","Moquillo:\r\n"
			   + "Es una enfermedad muy contagiosa producida por un virus, que afecta principalmente a cachorros no vacunados.\r\n"
			   + "Según el tipo de infección, el animal puede morir o quedar con lesiones permanentes; el problema suele comenzar con fiebre, ojos y nariz con secreciones, tos, diarrea y seguir con deshidratación, pérdida de peso y síntomas nerviosos."));
